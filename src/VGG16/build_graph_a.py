...
from vgg16_window_walker_lib_d import build_graph

build_graph(db_path, video_path, mask_path, video_files,  stride=stride, window_size=window_size, center_size=center_size, keep_times=False, max_elements=1000000)
